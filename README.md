...
curl -O https://raw.githubusercontent.com/HouchiKoutei/Develop/main/Setup_code-server.sh && chmod +x Setup_code-server.sh && ./Setup_code-server.sh
...
`https://raw.githubusercontent.com/HouchiKoutei/Develop/main/Setup_code-server.sh`
---